...
const USAGE: &str = "
Usage:
    kvs_disk.exe FILE get KEY
    kvs_disk.exe FILE delete KEY
    kvs_disk.exe FILE insert KEY
    kvs_disk.exe FILE update KEY
";

#[cfg(not(target_os = "windows"))]
const USAGE: &str = "
Usage:
    kvs_disk FILE get KEY
    kvs_disk FILE delete KEY
    kvs_disk FILE insert KEY
    kvs_disk FILE update KEY
";
